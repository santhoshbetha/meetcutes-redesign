      ...
      <div className="p-6">
        <div className="flex gap-4 mb-4">
          ...
          <div className="relative">
            <div className={`w-20 h-20 rounded-2xl overflow-hidden flex-shrink-0 shadow-lg group-hover:shadow-xl transition-shadow duration-300 ${avatarClass}`}>
              {profile?.image ? (
                <img
            ...
            <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-green-500 border-3 border-card rounded-full shadow-sm flex items-center justify-center">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between mb-2">
              ...
              <div className="inline-flex items-center px-2 py-1 bg-primary/10 text-primary rounded-full text-xs font-semibold ml-2">
                {profile?.age}
              </div>
            </div>
            ...
            <div className="flex items-center gap-1 mb-3">
              {interests.map((interest, index) => (
                <div key={index} className="flex items-center gap-1 px-2 py-1 bg-muted/50 rounded-full">
                  <interest.icon className="w-3 h-3 text-muted-foreground" />
