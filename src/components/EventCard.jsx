...
export function EventCard({ setSelectedEvent, event, userlatitude, userlongitude }) {
  ...
  return (
    <Card
      ...
      className="group p-0 shadow-xl border-borderX/60 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 hover:scale-[1.02]
      dark:border-blue-900/80
      cursor-pointer hover:border-primary/40 bg-gradient-to-br from-card to-card/90"
    >
      <div className="p-6">
        <div className="mb-2">
